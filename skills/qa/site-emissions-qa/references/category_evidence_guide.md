...
2. All receipts accounted for in calc sheet
3. Correct math in calc sheet (consumption + transport)
4. Transport distance correct and documented
5. Transport mass correct (matches purchase records)
6. Transport emissions correctly calculated
7. EF matches Standard Emission Factors list
8. Certify component value matches calc sheet total (consumption + transport)
...
6. Transport process emissions correct
7. Transport embodied emissions correct
8. Argon electricity usage correctly calculated
9. EFs match Standard Emission Factors list
10. Certify component values match calc sheet outputs (all sub-components)
